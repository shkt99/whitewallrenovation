...
export default function Gallery() {
  return (
    <main id="main-content">
      ...
      <section className="py-16 md:py-24 bg-background" aria-labelledby="gallery-intro">
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            <p className="text-muted-foreground text-base md:text-lg max-w-3xl mx-auto">
              Welcome to our Gallery, where we showcase the stunning transformations 
              achieved by White Wall Renovation. Our commitment to quality craftsmanship, 
              innovative design, and personalized service is evident in every project we 
              undertake. Take a visual journey through our portfolio of homes we've had 
              the privilege of renovating.
            </p>
          </div>
      ...
      <section className="py-16 md:py-24 bg-muted" aria-labelledby="before-after-heading">
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl mx-auto">
              Drag the slider to see the dramatic before and after transformations 
              of our renovation projects.
            </p>
          </div>
      ...
      <section className="py-16 md:py-24 bg-background" aria-labelledby="cta-heading">
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 text-center">
          ...
          <p className="text-muted-foreground text-base md:text-lg max-w-2xl mx-auto mb-8">
            Your dream home is just a conversation away. Contact us today to discuss 
            your renovation project and get a free quote.
          </p>
          <Link href="/contact">
