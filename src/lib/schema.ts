...
export const services = [
  ...
  },
  {
    ...
    shortDescription: "Complete bathroom transformations",
    description: "Transform your bathroom into a luxurious retreat with our comprehensive bathroom remodelling services. From modern fixtures to spa-like features, we handle every detail to create your dream bathroom.",
    features: [
